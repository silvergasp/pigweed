...
_TARGETS_THAT_DONT_BUILD_WITH_BAZEL = [
    'node_modules/...',
    'pw_arduino_build/...',
    'pw_bytes/size_report:build_byte_buffer',
    'pw_crypto:ecdsa_boringssl',
    'pw_crypto:ecdsa_mbedtls',
    'pw_crypto:ecdsa_test',
    'pw_crypto:ecdsa_uecc_c',
    'pw_crypto:ecdsa_uecc',
    'pw_crypto:sha256_boringssl',
    'pw_crypto:sha256_mbedtls',
    'pw_crypto:sha256_mock_test',
    'pw_crypto:sha256_mock',
    'pw_crypto:sha256_test',
    'pw_crypto/size_report:ecdsa_p256_verify',
    'pw_crypto/size_report:sha256_simple',
    'pw_function/size_report:callable_size',
    'pw_hdlc/rpc_example:rpc_example',
    'pw_metric:metric_service_nanopb_test',
    'pw_metric:metric_service_nanopb',
    'pw_minimal_cpp_stdlib:minimal_cpp_stdlib_isolated_test',
    'pw_minimal_cpp_stdlib:test',
    'pw_protobuf_compiler/ts:lib',
    'pw_protobuf_compiler/ts:pw_protobuf_compiler',
    'pw_protobuf_compiler/ts:test_proto_collection_esm',
    'pw_protobuf_compiler/ts:test_proto_collection_lib',
    'pw_protobuf_compiler/ts:test_proto_collection',
    'pw_protobuf_compiler/ts:ts_proto_collection_test_js_sources',
    'pw_protobuf_compiler/ts:ts_proto_collection_test_lib',
    'pw_protobuf_compiler/ts:ts_proto_collection_test',
    'pw_rpc/ts:lib',
    'pw_rpc/ts:pw_rpc',
    'pw_rpc/ts:rpc_proto_collection_esm',
    'pw_rpc/ts:rpc_proto_collection_lib',
    'pw_rpc/ts:rpc_proto_collection',
    'pw_rpc/ts:rpc_test_js_sources',
    'pw_rpc/ts:rpc_test_lib',
    'pw_rpc/ts:rpc_test',
    'pw_sys_io_mcuxpresso:pw_sys_io_mcuxpresso',
    'pw_sys_io_stm32cube/...',
    'pw_software_update/...',
    'pw_thread_freertos:util',
    'pw_thread_threadx:snapshot',
    'pw_thread_threadx:util',
    'pw_tls_client:build_time',
    'pw_tls_client:test_server_test',
    'pw_tls_client:test_server',
    'pw_trace_tokenized:trace_rpc_service',
    'pw_transfer/ts:lib',
    'pw_transfer/ts:pw_transfer',
    'pw_transfer/ts:test_js_sources',
    'pw_transfer/ts:test_lib',
    'pw_transfer/ts:test',
    'pw_transfer/ts:transfer_proto_collection_esm',
    'pw_transfer/ts:transfer_proto_collection_lib',
    'pw_transfer/ts:transfer_proto_collection',
    'pw_web_ui:app_bundle',
    'pw_web_ui:devserver',
    'pw_web_ui:lib',
    'pw_web_ui:pw_web_ui',
    'pw_web_ui:web_proto_collection_esm',
    'pw_web_ui:web_proto_collection_lib',
    'pw_web_ui:web_proto_collection',
    'pw_web_ui:web_ui_test_bundle',
    'pw_web_ui:web_ui_test_lib',
    'pw_web_ui:web_ui_test',
    'targets/...',
]

_TARGETS_THAT_DONT_TEST_WITH_BAZEL = [
    'pw_malloc_freelist:freelist_malloc_test', 'pw_crypto:ecdsa_test',
    'pw_crypto:sha256_mock_test', 'pw_crypto:sha256_test',
    'pw_metric:metric_service_nanopb_test', 'pw_minimal_cpp_stdlib:test'
] + _TARGETS_THAT_DONT_BUILD_WITH_BAZEL
...
def bazel_test(ctx: PresubmitContext) -> None:
    ...
    build.bazel(
        ctx, 'test', '--test_output=errors', '--', '...',
        *['-' + target for target in _TARGETS_THAT_DONT_TEST_WITH_BAZEL])
...
def bazel_build(ctx: PresubmitContext) -> None:
    ...
    build.bazel(
        ctx, 'build', '--', '...',
        *['-' + target for target in _TARGETS_THAT_DONT_BUILD_WITH_BAZEL])
